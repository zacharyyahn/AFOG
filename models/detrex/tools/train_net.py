...
# Modified for attacks
#sys.path.append('/home/hice1/zyahn3/scratch/TOG_plus/tog/attacks.py')
from attacks import *
...
def do_test(cfg, model, eval_only=False, attack=None, mode=None):
    ...
    if eval_only:
        ...
        if "evaluator" in cfg.dataloader:
            ret = inference_on_dataset(
                model, instantiate(cfg.dataloader.test), instantiate(cfg.dataloader.evaluator), attack=attack, mode=mode
            )
...
def main(args):
    ...
    if args.eval_only:
        ...
        print(do_test(cfg, model, eval_only=True, attack=attack, mode=args.attack_mode))
    else:
        do_train(args, cfg)
