...
for n_iter in range(2, 22, 2):
    ...
    scores = evaluate_dataset(detector, im_path, annot_path, num_examples=500, attack=tog_attention, attack_params={"n_iter": n_iter, "eps": eps, "eps_iter":eps_iter}, flag_attack_fail=False)
