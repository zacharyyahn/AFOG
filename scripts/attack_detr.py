...
from utils.detr_utils.engine import evaluate
from utils.detr_utils import build_model
import utils.dataset_utils.coco
import utils.detr_utils.misc as utils
...
#     print("git:\n  {}\n".format(utils.get_sha()))
    ...
    if args.resume:
        if args.resume.startswith('https'):
            ...
            checkpoint = torch.load(args.resume, 'cpu', weights_only=True)
